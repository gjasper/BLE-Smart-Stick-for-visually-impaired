...
import com.example.ghj.bluetooth_terminal.activity.DeviceControlActivity;
...
public class SimpleGeofenceStore {
    ...
    private static int numberOfStoredGeofences;
    ...
    public SimpleGeofenceStore(Context context) {
        ...
        if (getGeofence(String.valueOf(1)) == null) {
            setNextValidId(1);
            setNumberOfStoredGeofences(0);
        } else {
            int i = 1;
            while (getGeofence(String.valueOf(i)) != null) {
                i++;
            }
            setNextValidId(i);
            setNumberOfStoredGeofences(i-1);
        }
    }

    public int getNumberOfStoredGeofences() {
        return numberOfStoredGeofences;
    }
    ...
    public void setNumberOfStoredGeofences(int numberOfStoredGeofencesX) {
        numberOfStoredGeofences= numberOfStoredGeofencesX;
    }

    public void setNextValidId(int NextValidIdX) {
        nextValidId=NextValidIdX;
    }
    ...
    public void setGeofence(String id, SimpleGeofence geofence) {
        ...
        //Increase the number of active geofences
        numberOfStoredGeofences = getNumberOfStoredGeofences() + 1;

        //Increase the number of the next valid id
        nextValidId = getNextValidId() + 1;
    ...
    public void clearGeofence(String id) {
        ...
        //Decrease the number of active geofences
        numberOfStoredGeofences = getNumberOfStoredGeofences() - 1;
    ...
    public void clearAllGeofences() {
        try {
            for (int i = 1; i < this.getNextValidId(); i++) {
                if (this.getGeofence(String.valueOf(i)) != null) {
                    this.clearGeofence(String.valueOf(this.getGeofence(String.valueOf(i)).getId()));
                }
            }
