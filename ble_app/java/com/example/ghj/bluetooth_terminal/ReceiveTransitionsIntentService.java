...
public class ReceiveTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (LocationClient.hasError(intent)) {
            ...
            if (
                ...
                String firstTriggeringGeofence = geofences.get(0).getRequestId();
                ...
                speechIntent.putExtra("MESSAGE", "Obstáculo próximo IDS: "+ids);
                ...
                */
                ...
                broadcastIntent.setAction(GeofenceUtils.ACTION_GEOFENCE_TRANSITION)
                        .putExtra(GeofenceUtils.EXTRA_GEOFENCE_STATUS, ids);
                */
                broadcastIntent.setAction(GeofenceUtils.ACTION_GEOFENCE_TRANSITION)
                        .putExtra(GeofenceUtils.EXTRA_GEOFENCE_STATUS, firstTriggeringGeofence);
    ...
    private void sendNotification(String transitionType, String ids) {
        ...
        Intent notificationIntent =
                new Intent(getApplicationContext(), DeviceControlActivity.class);
